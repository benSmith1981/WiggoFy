...
{
    [super viewDidLoad];
    [text1 setFont:[UIFont fontWithName:@"AEnigmaScrawl4BRK" size:15]];
    text2.font = [UIFont fontWithName:@"AEnigmaScrawl4BRK" size:15];
    label.text = @"BACK";
    label.font = [UIFont fontWithName:@"AEnigmaScrawl4BRK" size:20];
